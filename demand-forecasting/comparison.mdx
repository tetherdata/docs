...
2. Go to [**Forecast Admin**](/demand-forecasting/admin) → the **Models** tab
...
- Assign the best-performing model per SKU-channel pair — see [Model assignment](/demand-forecasting/model-assignment)
