...
| [Simple Seasonal with Trend](#simple-seasonal-with-trend) | Seasonal products with growth trends | Yes | 365 days |
...
| Simple Seasonal with Trend | **Yes** | Nelder-Mead | `growth_factor`, observation/horizon windows, `initial_trend_weight` |
...
<AccordionGroup>
  ...
  <Accordion title="Seasonal demand — recurring annual cycles">
    Start with **Simplified Seasonal** for straightforward seasonal products. If your products also exhibit year-over-year growth, use **Seasonal YoY Growth** or **Simple Seasonal with Trend**. For complex patterns with both trend and seasonality, **Holt-Winters** offers the most flexibility.
  </Accordion>
