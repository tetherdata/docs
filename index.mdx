...
<CardGroup cols={2}>
  <Card title="Admin Users" icon="user-shield">
    Full access to all features including inventory management, supplier configuration, integrations, and user administration.
  </Card>
  <Card title="Sales Rep Users" icon="user">
    Focused access to sales history, demand forecasts, and channel information for day-to-day operations.
  </Card>
</CardGroup>
