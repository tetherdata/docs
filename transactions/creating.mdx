...
## Creating from planning recommendations

The easiest way to create transactions is from the solver's recommendations on the supply planning pages:
...
<Steps>
  ...
  <Step title="Review recommendations">
    Look at the solver-recommended movements and their rationale
  </Step>

  <Step title="Accept">
    Click **Accept** on a recommendation to commit it to the [execution plan](/supply-planning/execution-plan)
  </Step>

  <Step title="Order">
    Use **Place order** (or the **Order** row action) on the committed movement to convert it into a real transaction
  </Step>
</Steps>

See [Working with recommendations](/supply-planning/recommendations) for details on working with recommendations.
...
<CardGroup cols={2}>
  ...
  <Card title="Recommendations" icon="clipboard-list" href="/supply-planning/recommendations">
    Create from planning recommendations
  </Card>
