...
Lead times directly impact [supply planning](/supply-planning/overview) recommendations:
...
3. **Times recommendations** — Recommended [transfers](/supply-planning/transfers) and [purchases](/supply-planning/purchases) are scheduled around lead times
...
If coverage drops below the lead time, the shortfall surfaces in [inventory coverage](/supply-planning/coverage).
...
<CardGroup cols={2}>
  ...
  <Card title="Inventory Coverage" icon="chart-line" href="/supply-planning/coverage">
